...
network = import_system(:rtsgmlc; damping, scale_inertia=1.4, tconst = 0.01u"s")
...
length(sol.failures.saveval)-1 # `-1` as we don't want to count the initial failure
length(sol.failures_nodes.saveval)
