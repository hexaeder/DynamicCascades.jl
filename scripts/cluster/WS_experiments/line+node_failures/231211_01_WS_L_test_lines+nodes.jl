...
folder = string("/",datetime,"WS_inertia_vs_line+node_failures_f_bound=$freq_bound")
directory = string(RESULTS_DIR,folder)
mkpath(directory)


network0 = import_system(:wattsstrogatz; N=N, k=4, β=0.7, graph_seed=124, distr_seed=1230, K=1, γ=1u"s", τ=1u"s", σ=1.0)
...
@time for scale_inertia in scale_inertia_values
    network = import_system(:wattsstrogatz; N=N, k=4, β=0.7, M=(scale_inertia * 1u"s^2"), graph_seed=124, distr_seed=1230, K=1, γ=1u"s", τ=1u"s", σ=1.0)
