...
# Experiment name
name = "WS_k=4_exp03_2_vary_I_only_nodes_"
long_name = "Only variation of inertia I. As in MA but using the same states for all number_of_task_ids_between_graphs. Node failure only model." # for providing more details
