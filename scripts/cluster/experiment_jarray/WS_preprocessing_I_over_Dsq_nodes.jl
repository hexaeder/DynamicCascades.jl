...
# Experiment name
name = "WS_k=4_exp05_2_I_over_Dsq_nodes_"
long_name = "I over D squared is constant. Node failure only model." # for providing more details
...
freq_bounds = [0.005, 0.01, 0.03, 0.15]
