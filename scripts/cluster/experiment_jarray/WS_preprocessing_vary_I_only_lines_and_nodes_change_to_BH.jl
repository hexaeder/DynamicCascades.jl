...
# Experiment name
name = "WS_k=4_exp11_vary_I_only_lines_and_nodes_change_to_BH_"
long_name = "Only variation of inertia I. As in MA but using the same states for all number_of_task_ids_between_graphs. Line and node failure model. Change to BH." # for providing more details
...
freq_bounds = [0.005, 0.010, 0.015, 0.020, 0.025, 0.030, 0.035, 0.040, 0.045, 0.050, 0.055, 0.060, 0.065, 0.070, 0.075, 0.080, 0.085, 0.090, 0.095, 0.100, 0.110, 0.120, 0.800]
