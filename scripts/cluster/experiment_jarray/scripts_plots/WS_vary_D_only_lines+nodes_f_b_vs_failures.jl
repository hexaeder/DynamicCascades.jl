...
for i in inertia_values
    ...
    CairoMakie.save(joinpath(MA_DIR, "WS", "fb_vs_failures", "WS_vary_D_only_f_b_vs_failures_lines+nodes_sumlinesnodes=$sum_lines_nodes,K=$K_str,k=$k_str,β=$filtered_β_values,I=$i.png"),fig_lines_and_nodes)
    CairoMakie.save(joinpath(MA_DIR, "WS", "fb_vs_failures", "WS_vary_D_only_f_b_vs_failures_lines+nodes_sumlinesnodes=$sum_lines_nodes,K=$K_str,k=$k_str,β=$filtered_β_values,I=$i.pdf"),fig_lines_and_nodes)
    # fig_lines_and_nodes
end
