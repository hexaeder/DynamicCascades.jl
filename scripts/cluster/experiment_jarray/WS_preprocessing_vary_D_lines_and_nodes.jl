...
# Experiment name
name = "WS_k=4_exp07_3_vary_D_lines_and_nodes_"
long_name = "Variation of Damping D while keeping inertia I constant. For different values of I. Line and node failure only model." # for providing more details
...
inertia_values = [0.5, 1.0, 3.0, 20.0]
...
if relate_inertia_and_damping
    ...
    γ_vals = [0.2, 0.5, 1.0, 3.0, 5.0, 7.5, 10.0, 20.0, 30.0] # damping swing equation nodes γ
end
