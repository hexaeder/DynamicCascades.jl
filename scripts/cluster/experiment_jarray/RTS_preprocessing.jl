...
# Experiment name
name = "RTS_exp02_"
long_name = "Uebergang frequency bounds and further values again..." # for providing more details
solver_name = "Rodas4P()"
...
# freq_bounds = [0.01, 0.08, 0.16, 0.24, 0.32, 0.40, 0.48, 0.56, 0.64, 0.70, 0.8, 0.90, 1.00, 1.2, 1.4, 1.6]
