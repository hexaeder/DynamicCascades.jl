...
long_name = "Variation of Damping D while keeping inertia I constant. For different values of I. Node failure only model." # for providing more details
