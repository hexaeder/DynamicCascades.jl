...
# Experiment name
name = "WS_k=4_exp03_1_vary_I_only_lines_"
long_name = "Only variation of inertia I. As in MA but using the same states for all number_of_task_ids_between_graphs. Line failure only model." # for providing more details
