...
#SBATCH --job-name=WS_k=10_K=6
#SBATCH --account=icone
#SBATCH --output=%x-%A_%a-%N.out
#SBATCH --error=%x-%A_%a-%N.err
#SBATCH --workdir=/home/brandner/MA_data/results_NB/WS_testrun_params_k=10PIK_HPC_K_=6,N_G=4_20240107_003424.962/output
#SBATCH --ntasks=1
...
exp_name_date="WS_testrun_params_k=10PIK_HPC_K_=6,N_G=4_20240107_003424.962"
