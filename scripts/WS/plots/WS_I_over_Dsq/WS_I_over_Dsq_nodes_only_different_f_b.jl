...
lines!(ax_nodes_only, [NaN], [NaN]; label=L"Damping $D=\sqrt{I}$ [$s$]", color=:white)
...
CairoMakie.save(joinpath(MA_DIR, "WS", "WS_I_over_Dsq_nodes_only_K=$K_str,k=$k_str,β=$filtered_β_values,f_b=$filtered_freq_bounds_str,M_left_out=$left_out_inertia_values.png"),fig_nodes_only)
CairoMakie.save(joinpath(MA_DIR, "WS", "WS_I_over_Dsq_nodes_only_K=$K_str,k=$k_str,β=$filtered_β_values,f_b=$filtered_freq_bounds_str,M_left_out=$left_out_inertia_values.pdf"),fig_nodes_only)
fig_nodes_only
