...
CairoMakie.save("N=10_WS_vary_I_only_heatmap_log=$heatmap_logscale,sumlinesnodes=$sum_lines_nodes,K=$K_str,k=$k_str,β=$filtered_β_values.pdf",fig_hm)
CairoMakie.save("N=10_WS_vary_I_only_heatmap_log=$heatmap_logscale,sumlinesnodes=$sum_lines_nodes,K=$K_str,k=$k_str,β=$filtered_β_values.png",fig_hm)
fig_hm
