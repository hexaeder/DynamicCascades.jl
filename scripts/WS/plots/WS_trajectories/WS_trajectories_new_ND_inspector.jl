...
## 1720
inspect(sol1720; restart=true, reset=true)

set_sol!(sol1720) # optional if after inspect(sol)
...
define_timeseries!([
    (; selcomp=[VIndex(29), VIndex(58), VIndex(92), VIndex(98), VIndex(59), VIndex(60), VIndex(61), VIndex(62)], states=[:ω, :ωmax], rel=false),
    (; selcomp=[EIndex(78), EIndex(199), EIndex(194), EIndex(131), EIndex(147), EIndex(14), EIndex(106), EIndex(135), EIndex(149), EIndex(148), EIndex(146)], states=[:S, :rating], rel=false),
])

# crashed on earlier version of NetworkDynamicsInspector.jl when switching Node state to ω
## 1723 
inspect(sol1723)
define_timeseries!([
    (; selcomp=[VIndex(29), VIndex(58), VIndex(92), VIndex(98), VIndex(59), VIndex(60), VIndex(61), VIndex(62)], states=[:ω, :ωmax], rel=false),
