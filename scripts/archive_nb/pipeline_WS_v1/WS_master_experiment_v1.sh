...
# CLUSTER2015 - brandner@login02:~/DynamicCascades.jl/scripts/cluster/experiment_jarray> ./WS_master_experiment.sh
# ------------------------------------------------------------
# Running experiment: WS_k=4_exp01_
# ------------------------------------------------------------
# SLURM JOB ID Preprocessing: 28847478
# Sleeping 400 seconds until variables for Slurm are assigned.
# sbatch: error: Batch job submission failed: Pathname of a file, directory or other parameter too long
# SLURM JOB ID JOBARRAY 1:
# sbatch: error: Batch job submission failed: Pathname of a file, directory or other parameter too long
# SLURM JOB ID JOBARRAY 2:
# Files will be saved in this folder: WS_k=4_exp01_PIK_HPC_K_=3,N_G=25_20240127_204326.41
# sbatch: error: Batch job submission failed: Job dependency problem
# SLURM JOB ID Postprocessing 1:
# sbatch: error: Batch job submission failed: Job dependency problem
# SLURM JOB ID Postprocessing 1:
